...
var h = (i, s3, t) => s3 in i ? e(i, s3, {
  enumerable: true,
  configurable: true,
  writable: true,
  value: t
}) : i[s3] = t;
var o = (i, s3, t) => h(i, typeof s3 != "symbol" ? s3 + "" : s3, t);
var _ = class {
  constructor() {
    o(this, "_locking");
    o(this, "_locks");
    ...
    equals(type, a3, b2) {
      ...
      return type.fields.byMember().every((m3) => {
        ...
        if (m3.repeated) {
          ...
          switch (m3.kind) {
            case "message":
              return va.every((a4, i) => m3.T.equals(a4, vb[i]));
            case "scalar":
              return va.every((a4, i) => scalarEquals(m3.T, a4, vb[i]));
            case "enum":
              return va.every((a4, i) => scalarEquals(ScalarType.INT32, a4, vb[i]));
          }
...
function r(r4, e3, n2) {
  ...
  var a3 = null != (i = n2.isImmediate) && i, u3 = null != (t = n2.callback) && t, c3 = n2.maxWait, v3 = Date.now(), l2 = [];
  function f2() {
    if (void 0 !== c3) {
      var r5 = Date.now() - v3;
    ...
    return new Promise(function(i2, t2) {
      ...
      if (void 0 !== o3 && clearTimeout(o3), o3 = setTimeout(function() {
        if (o3 = void 0, v3 = Date.now(), !a3) {
          var i3 = r4.apply(n3, e4);
          u3 && u3(i3), l2.forEach(function(r5) {
            return (0, r5.resolve)(i3);
          }), l2 = [];
        }
      }, f2()), c4) {
        var d4 = r4.apply(n3, e4);
        return u3 && u3(d4), i2(d4);
      }
      l2.push({
        resolve: i2,
        reject: t2
    ...
    if (!ddFound) {
      if (this.ddExtID === 0) {
        ...
        sdp2.media.forEach((m3) => {
          ...
          (_a3 = m3.ext) === null || _a3 === void 0 ? void 0 : _a3.forEach((ext) => {
            if (ext.value > maxID) {
              maxID = ext.value;
            }
          });
...
var LocalVideoTrack = class extends LocalTrack {
  ...
  getSenderStats() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      stats.forEach((v3) => {
        ...
        if (v3.type === "outbound-rtp") {
          const vs = {
            ...
            rid: (_a3 = v3.rid) !== null && _a3 !== void 0 ? _a3 : v3.id,
      ...
      items.sort((a3, b2) => {
        var _a3, _b2;
        return ((_a3 = b2.frameWidth) !== null && _a3 !== void 0 ? _a3 : 0) - ((_b2 = a3.frameWidth) !== null && _b2 !== void 0 ? _b2 : 0);
      });
      return items;
    });
  }
...
var r2 = class {
  static getFullOptions(e3) {
    ...
    const n2 = function(e4) {
      var t2, n3;
      const { textOnly: o3 } = null != (t2 = null == (n3 = e4.overrides) ? void 0 : n3.conversation) ? t2 : {}, { textOnly: i } = e4;
      return "boolean" == typeof i ? ("boolean" == typeof o3 && i !== o3 && console.warn(`Conflicting textOnly options provided: ${i} via options.textOnly (will be used) and ${o3} via options.overrides.conversation.textOnly (will be ignored)`), i) : "boolean" == typeof o3 ? o3 : void 0;
    }(e3);
    ...
    } }, e3, { textOnly: n2, overrides: s({}, e3.overrides, { conversation: s({}, null == (t = e3.overrides) ? void 0 : t.conversation, { textOnly: n2 }) }) });
  }
  constructor(e3, t) {
    var n2 = this;
...
var v = class _v extends c {
  ...
  static async create(e3) {
    ...
    try {
      ...
      let a3;
      const r4 = (null == (o3 = e3.overrides) || null == (o3 = o3.client) ? void 0 : o3.version) || u, c3 = (null == (i = e3.overrides) || null == (i = i.client) ? void 0 : i.source) || "js_sdk";
      if (e3.signedUrl) {
        const t2 = e3.signedUrl.includes("?") ? "&" : "?";
        a3 = `${e3.signedUrl}${t2}source=${c3}&version=${r4}`;
      } else a3 = `${s4}/v1/convai/conversation?agent_id=${e3.agentId}&source=${c3}&version=${r4}`;
      const h3 = ["convai"];
      e3.authorization && h3.push(`bearer.${e3.authorization}`), t = new WebSocket(a3, h3);
...
var y = class _y extends c {
  ...
  static async create(n2) {
    ...
    if ("conversationToken" in n2 && n2.conversationToken) o3 = n2.conversationToken;
      ...
      try {
        var i, s3, a3;
        const e3 = (null == (i = n2.overrides) || null == (i = i.client) ? void 0 : i.version) || u, t = (null == (s3 = n2.overrides) || null == (s3 = s3.client) ? void 0 : s3.source) || "js_sdk", c4 = `${r4 = null != (a3 = n2.origin) ? a3 : "https://api.elevenlabs.io", r4.replace(/^wss:\/\//, "https://")}/v1/convai/conversation/token?agent_id=${n2.agentId}&source=${t}&version=${e3}`, l2 = await fetch(c4);
    ...
    const c3 = new Room();
    try {
      const e3 = `room_${Date.now()}`, i2 = l("pcm_48000"), s4 = l("pcm_48000"), a4 = new _y(c3, e3, i2, s4, n2), r5 = n2.livekitUrl || "wss://livekit.rtc.elevenlabs.io";
      var d3;
      await c3.connect(r5, o3), await new Promise((e4) => {
        if (a4.isConnected) e4();
        else {
          const n3 = () => {
      ...
      }), c3.name && (a4.conversationId = (null == (d3 = c3.name.match(/(conv_[a-zA-Z0-9]+)/)) ? void 0 : d3[0]) || c3.name), n2.textOnly || await c3.localParticipant.setMicrophoneEnabled(true);
      const u3 = p(n2);
      return a4.debug({ type: h2, message: u3 }), await a4.sendMessage(u3), a4;
    } catch (e3) {
  ...
  setupRoomEventListeners() {
    ...
    }), this.room.on(RoomEvent.TrackSubscribed, async function(t, n2, i) {
  ...
  async setupAudioCapture(e3) {
    try {
      ...
      this.outputAnalyser.connect(i), i.port.postMessage({ type: "setFormat", format: this.outputFormat.format, sampleRate: this.outputFormat.sampleRate }), i.port.onmessage = (e4) => {
        const [t2, n3] = e4.data;
        if (n3 > 0.01) {
...
async function C(e3 = { default: 0, android: 3e3 }) {
  let t = e3.default;
  var n2;
...
var k = class _k extends r2 {
  static async startSession(e3) {
    ...
    let n2 = null;
    try {
      return await C(t.connectionDelay), n2 = await S(e3), new _k(t, n2);
    } catch (e4) {
      var o3;
...
var I = class _I {
  static async create({ sampleRate: e3, format: t, preferHeadphonesForIosDevices: n2, inputDeviceId: o3, workletPaths: i, libsampleratePath: a3, onError: r4 }) {
    let c3 = null, l2 = null;
    try {
      const u4 = s({ sampleRate: { ideal: e3 } }, R);
      if (E() && n2) {
        ...
        e4 && (u4.deviceId = { ideal: e4.deviceId });
      }
      o3 && (u4.deviceId = _I.getDeviceIdConstraint(o3));
      const d4 = navigator.mediaDevices.getSupportedConstraints().sampleRate;
      c3 = new window.AudioContext(d4 ? { sampleRate: e3 } : {});
      const h3 = c3.createAnalyser();
      if (!d4) {
        const e4 = a3 || "https://cdn.jsdelivr.net/npm/@alexanderolsen/libsamplerate-js@2.1.2/dist/libsamplerate.worklet.js";
        await c3.audioWorklet.addModule(e4);
      }
      await b(c3.audioWorklet, null == i ? void 0 : i.rawAudioProcessor);
      const p2 = s({ voiceIsolation: true }, u4);
      l2 = await navigator.mediaDevices.getUserMedia({ audio: p2 });
      const m3 = c3.createMediaStreamSource(l2), v3 = new AudioWorkletNode(c3, "rawAudioProcessor");
      v3.port.postMessage({ type: "setFormat", format: t, sampleRate: e3 }), m3.connect(h3), h3.connect(v3), await c3.resume();
      const g2 = await navigator.permissions.query({ name: "microphone" });
      return new _I(c3, h3, v3, l2, m3, g2, r4);
    } catch (e4) {
      var u3, d3;
      throw null == (u3 = l2) || u3.getTracks().forEach((e5) => {
        e5.stop();
      }), null == (d3 = c3) || d3.close(), e4;
    }
  }
  static getDeviceIdConstraint(e3) {
    if (e3) return E() ? { ideal: e3 } : { exact: e3 };
  }
  constructor(e3, t, n2, o3, i, s3, a3 = console.error) {
    this.context = void 0, this.analyser = void 0, this.worklet = void 0, this.inputStream = void 0, this.mediaStreamSource = void 0, this.permissions = void 0, this.onError = void 0, this.settingInput = false, this.handlePermissionsChange = () => {
      if ("denied" === this.permissions.state) this.onError("Microphone permission denied");
        ...
        var e4;
        const [t2] = this.inputStream.getAudioTracks(), { deviceId: n3 } = null != (e4 = null == t2 ? void 0 : t2.getSettings()) ? e4 : {};
        this.setInputDevice(n3).catch((e5) => {
          this.onError("Failed to reset input device after permission change:", e5);
        });
      }
    }, this.context = e3, this.analyser = t, this.worklet = n2, this.inputStream = o3, this.mediaStreamSource = i, this.permissions = s3, this.onError = a3, this.permissions.addEventListener("change", this.handlePermissionsChange);
  }
  forgetInputStreamAndSource() {
    for (const e3 of this.inputStream.getTracks()) e3.stop();
  ...
  async setInputDevice(e3) {
    try {
      ...
      const t = s({}, R);
      e3 && (t.deviceId = _I.getDeviceIdConstraint(e3));
      const n2 = s({ voiceIsolation: true }, t), o3 = await navigator.mediaDevices.getUserMedia({ audio: n2 });
      this.forgetInputStreamAndSource(), this.inputStream = o3, this.mediaStreamSource = this.context.createMediaStreamSource(o3), this.mediaStreamSource.connect(this.analyser);
    } catch (e4) {
      throw this.onError("Failed to switch input device:", e4), e4;
    } finally {
...
var A = class _A {
  static async create({ sampleRate: e3, format: t, outputDeviceId: n2, workletPaths: o3 }) {
    let i = null, s3 = null;
    try {
      i = new AudioContext({ sampleRate: e3 });
      const a4 = i.createAnalyser(), r5 = i.createGain();
      s3 = new Audio(), s3.src = "", s3.load(), s3.autoplay = true, s3.style.display = "none", document.body.appendChild(s3);
      const c3 = i.createMediaStreamDestination();
      s3.srcObject = c3.stream, r5.connect(a4), a4.connect(c3), await M(i.audioWorklet, null == o3 ? void 0 : o3.audioConcatProcessor);
      const l2 = new AudioWorkletNode(i, "audioConcatProcessor");
      return l2.port.postMessage({ type: "setFormat", format: t }), l2.connect(r5), await i.resume(), n2 && s3.setSinkId && await s3.setSinkId(n2), new _A(i, a4, r5, l2, s3);
    } catch (e4) {
      var a3, r4;
      throw null != (a3 = s3) && a3.parentNode && s3.parentNode.removeChild(s3), null == (r4 = s3) || r4.pause(), i && "closed" !== i.state && await i.close(), e4;
    }
  }
  constructor(e3, t, n2, o3, i) {
    this.context = void 0, this.analyser = void 0, this.gain = void 0, this.worklet = void 0, this.audioElement = void 0, this.context = e3, this.analyser = t, this.gain = n2, this.worklet = o3, this.audioElement = i;
  }
...
var D = class _D extends r2 {
  ...
  static async startSession(e3) {
    ...
    let o3 = null, i = null, a3 = null, c3 = null, l2 = null;
    (null == (t = e3.useWakeLock) || t) && (l2 = await _D.requestWakeLock());
    try {
      var u3;
      return c3 = await navigator.mediaDevices.getUserMedia({ audio: true }), await C(n2.connectionDelay), i = await S(e3), [o3, a3] = await Promise.all([I.create(s({}, i.inputFormat, { preferHeadphonesForIosDevices: e3.preferHeadphonesForIosDevices, inputDeviceId: e3.inputDeviceId, workletPaths: e3.workletPaths, libsampleratePath: e3.libsampleratePath })), A.create(s({}, i.outputFormat, { outputDeviceId: e3.outputDeviceId, workletPaths: e3.workletPaths }))]), null == (u3 = c3) || u3.getTracks().forEach((e4) => {
        e4.stop();
      }), c3 = null, new _D(n2, i, o3, a3, l2);
    } catch (e4) {
      var d3, h3, p2, m3;
      n2.onStatusChange && n2.onStatusChange({ status: "disconnected" }), null == (d3 = c3) || d3.getTracks().forEach((e5) => {
        e5.stop();
      }), null == (h3 = i) || h3.close(), await (null == (p2 = o3) ? void 0 : p2.close()), await (null == (m3 = a3) ? void 0 : m3.close());
      try {
        var v3;
  ...
  constructor(e3, t, n2, o3, i) {
    ...
    }, this.input = n2, this.output = o3, this.wakeLock = i, this.input.worklet.port.onmessage = this.onInputWorkletMessage, this.output.worklet.port.onmessage = this.onOutputWorkletMessage, i && (this.visibilityChangeHandler = () => {
      var e4;
  ...
  handleAudio(e3) {
    var t, n2;
    super.handleAudio(e3), e3.audio_event.alignment && this.options.onAudioAlignment && this.options.onAudioAlignment(e3.audio_event.alignment), this.lastInterruptTimestamp <= e3.audio_event.event_id && (e3.audio_event.audio_base_64 && (null == (t = (n2 = this.options).onAudio) || t.call(n2, e3.audio_event.audio_base_64), this.connection instanceof y || this.addAudioBase64Chunk(e3.audio_event.audio_base_64)), this.currentEventId = e3.audio_event.event_id, this.updateCanSendFeedback(), this.updateMode("speaking"));
  }
  setMicMuted(e3) {
    this.connection instanceof y ? this.connection.setMicMuted(e3) : this.input.setMuted(e3);
  }
  getInputByteFrequencyData() {
  ...
  async changeInputDevice({ sampleRate: e3, format: t, preferHeadphonesForIosDevices: n2, inputDeviceId: o3 }) {
    try {
      ...
      this.connection instanceof y && await this.connection.setAudioInputDevice(o3 || ""), await this.input.close();
      const i = await I.create({ sampleRate: null != e3 ? e3 : this.connection.inputFormat.sampleRate, format: null != t ? t : this.connection.inputFormat.format, preferHeadphonesForIosDevices: n2, inputDeviceId: o3, workletPaths: this.options.workletPaths, libsampleratePath: this.options.libsampleratePath, onError: this.options.onError });
  ...
  async changeOutputDevice({ sampleRate: e3, format: t, outputDeviceId: n2 }) {
    try {
      ...
      this.connection instanceof y && await this.connection.setAudioOutputDevice(n2 || ""), await this.output.close();
      const o3 = await A.create({ sampleRate: null != e3 ? e3 : this.connection.outputFormat.sampleRate, format: null != t ? t : this.connection.outputFormat.format, outputDeviceId: n2, workletPaths: this.options.workletPaths });
  ...
  static async streamFromMicrophone(e3, t) {
    ...
    try {
      ...
      g2.sampleRate !== n2 && _3.port.postMessage({ type: "configure", inputSampleRate: g2.sampleRate, outputSampleRate: n2 }), _3.port.onmessage = (e4) => {
        ...
        let i2 = "";
        for (let e5 = 0; e5 < o4.length; e5++) i2 += String.fromCharCode(o4[e5]);
        const s4 = btoa(i2);
...
function a2(i = {}) {
  const { onSessionStarted: a3, onPartialTranscript: s3, onCommittedTranscript: c3, onCommittedTranscriptWithTimestamps: d3, onError: v3, onAuthError: m3, onQuotaExceededError: g2, onCommitThrottledError: p2, onTranscriberError: T2, onUnacceptedTermsError: h3, onRateLimitedError: C2, onInputError: S2, onQueueOverflowError: E2, onResourceExhaustedError: M2, onSessionTimeLimitExceededError: I2, onChunkSizeExceededError: D2, onInsufficientAudioActivityError: w2, onConnect: A2, onDisconnect: R2, token: b2, modelId: y2, baseUri: f2, commitStrategy: O2, vadSilenceThresholdSecs: U2, vadThreshold: k2, minSpeechDurationMs: F2, minSilenceDurationMs: _3, languageCode: P2, microphone: x2, audioFormat: N2, sampleRate: V, autoConnect: L2 = false, includeTimestamps: q } = i, B = (0, import_react.useRef)(null), [H, $] = (0, import_react.useState)("disconnected"), [Q, W2] = (0, import_react.useState)(""), [X, j] = (0, import_react.useState)([]), [z, K] = (0, import_react.useState)(null);
  ...
  const Y = (0, import_react.useCallback)(async (n2 = {}) => {
    if (B.current) console.warn("Already connected");
      ...
      var e3, r4;
      $("connecting"), K(null);
      const o3 = n2.token || b2, i2 = n2.modelId || y2;
      if (!o3) throw new Error("Token is required");
      if (!i2) throw new Error("Model ID is required");
  ...
  }, [b2, y2, f2, O2, U2, k2, F2, _3, P2, x2, N2, V, q, a3, s3, c3, d3, v3, m3, g2, p2, T2, h3, C2, S2, E2, M2, I2, D2, w2, A2, R2]), Z = (0, import_react.useCallback)(() => {
    var n2;
